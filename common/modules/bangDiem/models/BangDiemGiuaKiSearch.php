...
# @Last modified time: 2016-11-30T23:15:54+07:00
...
/**
 * BangDiemGiuaKiSearch represents the model behind the search form about `common\modules\bangDiem\models\BangDiemGiuaKi`.
 */
class BangDiemGiuaKiSearch extends BangDiemGiuaKi
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['uid', 'status', 'created_by', 'updated_by'], 'integer'],
            [['ma_hoc_sinh', 'ma_lop', 'ma_mon', 'ten_hoc_sinh', 'ten_lop', 'ten_mon', 'created_at', 'updated_at'], 'safe'],
